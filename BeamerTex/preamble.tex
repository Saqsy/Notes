...
I've since changed my mind a little \& have re-jigged the notes quite heavily over the years.
\end{frame}
...
electronically - even after the submission deadline - it's against our rules.
...
\begin{itemize}[<+->]
\item Lectured 4 hours per week (Neill \& Kira) for weeks 1-11 (barring week 6)
...
\item Three assignments (forming a Coursework Portfolio of 70\%) and a final, written exam (30\%).
\item Timings are slightly variable, so don't make any plans in advance -
...
\begin{itemize}[<+->]
\item All information is available via the Blackboard site (which will point you to other sites including \url{github.com}, MS Teams etc.)
\item Online support is given via the Teams Group.
